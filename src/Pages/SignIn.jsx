            ...
            <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
                <form>
                    <input type='email' id='email' value={email}
                     ...
                     className='text-xl w-full px-4 py-2 text-gray-700 bg-white border-gray-300 rounded
                     ...
                     <button type="submit" className='bg-blue-600 py-5 px-3 text-white
                 w-full text-sm font-medium uppercase 
                 rounded shadow-sm hover:bg-blue-700 transition duration-150
